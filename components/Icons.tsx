...
export const TrophyIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-yellow-400" fill="currentColor" viewBox="0 0 16 16">
        <path d="M2.5.5A.5.5 0 0 1 3 .5V2h10V.5a.5.5 0 0 1 1 0V2a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1V.5a.5.5 0 0 1 .5-.5zM3 3h10v1H3V3z"/>
        <path d="M4 11.5a3.5 3.5 0 1 1 8 0V16a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-4.5zM4.5 11c0 .538.224 1.01.568 1.348A3.498 3.498 0 0 1 8 13.5a3.498 3.498 0 0 1 2.932-2.152A2.498 2.498 0 0 0 11.5 11V9.5a2.5 2.5 0 0 0-5 0v1.5z"/>
    </svg>
);
...
const MedalIcon = ({ color }: { color: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill={color}>
        <path fillRule="evenodd" d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" clipRule="evenodd" />
    </svg>
);

export const GoldMedalIcon = () => <MedalIcon color="#FBBF24" />;
export const SilverMedalIcon = () => <MedalIcon color="#D1D5DB" />;
export const BronzeMedalIcon = () => <MedalIcon color="#D97706" />;
...
export const IdIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 012-2h4a2 2 0 012 2v1m-4 0h4m-9 4h2m-2 4h2m-2 4h2m6-4h.01M15 16h.01" />
    </svg>
);
